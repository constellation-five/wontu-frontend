...
@Component({
  ...
  standalone: true,
  imports: [MatDialogModule, MatButtonModule, MatIconModule, DialogComponent],
  template: `
    <app-dialog [title]="truncatedTitle()" [showClose]="true">
      <div class="preview-content">
        <img [src]="data.imageUrl" [alt]="data.title ?? 'Image preview'" />
      </div>
    </app-dialog>
  `,
...
export class ImagePreviewDialog {
  ...
  protected readonly truncatedTitle = computed(() => truncateMiddle(this.data.title ?? 'Preview'));
}
