# WontuFrontend Agent Instructions
...
- Use the generated spacing utilities from `src/material-theme.scss` for simple margin and padding needs, such as `.mb-lg`, `.px-2xs`, `.mx-md`, and `.py-sm`.
